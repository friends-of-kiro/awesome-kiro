...
## Community resources
- [KiroHub](https://kirohub.dev/) - a searchable repository of steering files, hooks, MCPs, and powers
...
- [Erik Hanchett - Top 8 Tips When Working With Kiro](https://kiro.hashnode.dev/top-8-tips-when) - mostly newcomer tips but not only
